...
{
    //WE MADE THE SERVICES FILE INSIDE THE SERVICES FOLDER SO THAT WE CAN MAKE OUR LOGIN HERE AND JUST USE IT IN CONTROLLERS
    // AND MAKE THE CONTROLLER LIGHTWEIGHT AND LAOS THIS IS A GOOD PRACTIE AND ACCORDING TO THE CLEAN ARCHITECTURE
